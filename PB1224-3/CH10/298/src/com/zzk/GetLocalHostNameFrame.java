    ...
    public GetLocalHostNameFrame() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                try {
                    InetAddress inetAddr = InetAddress.getLocalHost();// 建立本機主機的InetAddress對像
                    String canonical = inetAddr.getCanonicalHostName();// 獲得本機主機的域名
                    String host = inetAddr.getHostName();// 獲得本機主機的主機名
                    tf_canonical.setText(canonical);// 在純文字框中顯示本機主機的域名
                    tf_host.setText(host);// 在純文字框中顯示本機主機的主機名
