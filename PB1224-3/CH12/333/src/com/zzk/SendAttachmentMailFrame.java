...
public class SendAttachmentMailFrame extends JFrame {
        ...
        btn_send.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "發送失敗...\n\n使用者名稱或密碼不正確。");
                }
            }
        });
    ...
    public void init() throws Exception {
        ...
        props.put("mail.smtp.auth", "true");// 設定發郵件時需要身份驗證
        Authenticator check = new CheckAuthenticator();// 建立Authenticator實例
        session = Session.getDefaultInstance(props,check);// 建立Session對像
    }
    public void sendMessage(String fromAddr,String toAddr,String title,String text) throws Exception {
        ...
        Transport.send(msg);// 發送郵件時，進行身份驗證
